...
class VisitingCard extends StatefulWidget {
  ...
  const VisitingCard({Key? key, required this.userName, required this.designation}) : super(key: key);
    ...
    return Container(
      ...
      child: Stack(
          ...
          children: [
            ...
            const VisitingCardName(userName: 'Ashutosh Kumar', designation: 'App Developer',),
          ]
      ),
    );
  }
...
class VisitingCardName extends StatefulWidget {
  final String userName;
  final String designation;
  const VisitingCardName({Key? key, required this.userName, required this.designation}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Image.asset('assets/userProfile.png',width: 59,height: 59,),
           Padding(
            padding: const EdgeInsets.only(top: 8),
            child: Text(widget.userName,style: Styles.cardName,),
          ),
           Text(widget.designation,style: Styles.designation,)
        ],
      ),
    );
  }
