    ...
    return SafeArea(
      child: Consumer<Auth>(
        builder: (context, userProv, child) {
          final user = userProv.userDetails;
          return Scaffold(
                    ...
                    Padding(
                      ...
                      child: ClipShadowPath(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsets.only(left: width * 0.05, top: 10),
                            child: Column(
                              children: [
                                const Text(
                                  "BondU",
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Row(
                        children: [
                          ...(Socials.recommendedSocials + Socials.otherSocials)
                              .map((e) {
                            if (user.socialMediaHandles?[e] != null) {
                              return Padding(
                    ...
                    child: SfCartesianChart(
                        ...
                        series: <CartesianSeries<ConnectionData, String>>[
                          LineSeries<ConnectionData, String>(
                            ...
                            color: primaryColor,
                            dataSource: data,
                            xValueMapper: (ConnectionData sales, _) =>
                                sales.date,
